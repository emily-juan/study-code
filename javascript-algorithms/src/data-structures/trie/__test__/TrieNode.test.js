...
describe('TrieNode', () => {
  ...
  it('should check if node has specific children', () => {
    const trieNode = new TrieNode('c');
  ...
  it('should NOT delete child node if the child node complates a word', () => {
    const trieNode = new TrieNode('c');
    const IS_COMPLATE_WORD = true;
    trieNode.addChild('a', IS_COMPLATE_WORD);
