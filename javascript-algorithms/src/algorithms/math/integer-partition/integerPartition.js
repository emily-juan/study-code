...
export default function integerPartition(number) {
  ...
  // Let's fill the first row that represents how many ways
  // we would have to combine the numbers 1,2,3...,n with number 0.
  // We would have zero ways obviously since with zero number we may form only zero.
  for (let numberIndex = 0; numberIndex <= number; numberIndex += 1) {
